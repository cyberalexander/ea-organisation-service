DROP TABLE IF EXISTS ea_organisations;

CREATE TABLE ea_organisations (
...
INSERT INTO ea_organisations (organization_id, name, contact_name, contact_email, contact_phone)
